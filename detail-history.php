                            ...
                            ?>
                                ...
                                <a href="history.php">
                                    <span>
                                        ...
                                        <?php echo $_SESSION['user1']['customerid']; ?>
                                    </span>
                                </a>
                            <?php } else { ?>
                ...
                <div class="table-responsive">
                    <table class="table cart-table">
                        ...
                        if (isset($_SESSION['user1'])) {
                            ...
                            $Total = 0;
                            $result1 = mysqli_query($conn, "SELECT * FROM order_detail WHERE orderid = '" . $_GET['orderid'] . "'");
                        ?>
                            <thead>
                                <tr>
                                    <th>product Name</th>
                            ...
                            <tbody>
                                ...
                                if (!empty($result1)) {
                                    foreach ($result1 as $item) {
                                        extract($item);
                                        $result2 = mysqli_query($conn, "SELECT * FROM products WHERE productid ='" . $item['productid'] . "'");
                                        $detail = mysqli_fetch_assoc($result2);
                                ?>
                                        <tr>
                                            <td><?= $detail['productname'] ?></td>
                                            <td><?= $quantity ?></td>
                                            <td><?= number_format($detail['price']);
                                                $Total += ($detail['price'] * $quantity) ?> <sup>đ</sup></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align:center;background:#ce2c6c;color:#fff"><b>SUM PRICE</b></td>
                                            <td style="text-align:center;background:bisque;color:red"><b><?= number_format($Total) ?> <sup>đ</sup></b></td>
                                        </tr>
                            <?php }
                                }
                            } ?>
