                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="header">
                                    <h3 class="title">Category Management</h3><br>
                                </div>
                                <div class="content table-responsive table-full-width">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $categoryname ?></td>
                                                    <td>
                                                        <a href="update_category.php?categoryid=<?= $categoryid ?>"><button class="btn btn-primary">Update</button></a>
                                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa tài khoản này ?')" href="delete_category.php?categoryid=<?= $categoryid ?>">
                                    ...
                                    <a href="add_category.php"><button class="btn btn-danger">+ New Category</button></a>
                                </div>
                            </div>
                        </div>
