                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                ...
                                if (array_key_exists("insert", $_REQUEST)) {
                                    $stmt = $pdo->prepare("INSERT INTO category(categoryname) SELECT '$categoryname'
                                    WHERE NOT EXISTS (SELECT * FROM category WHERE categoryname = '$categoryname')");
                                    $stmt->execute();
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="">ID:</label>
                                        <input type="text" class="form-control" placeholder="Auto number" readonly>
                                    </div>
                                    <div class="form-group">
