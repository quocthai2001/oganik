                    ...
                    <table class="table cart-table">
                        ...
                        <tbody>
                            ...
                            if (isset($_SESSION['user1'])) {
                                ...
                                $Total = 0;
                                $result1 = mysqli_query($conn, "SELECT * FROM `order`
                                    WHERE customerid = '" . $_SESSION['user1']['customerid'] . "'");
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?= $value['note'] ?></td>
                                        <?php if ($value['cancle_order'] != 2) { ?>
                                            <td>
                                                <?php
                                                if ($value['order_status'] == 0) {
                                                    echo '<button class="btn btn-danger name="">';
                                                    echo "Chưa xử lý";
                                                } else {
                                                    echo '<button class="btn btn-primary name ="">';
                                                    echo "Đã xử lý";
                                                }
                                                ?>
                                            </td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <a href="delete-order.php?orderid=<?= $value['orderid'] ?>">
                                                    <?php
                                                    if ($value['cancle_order'] == 0) { ?>
                                                        <button class="btn btn-warning text-white">Yêu cầu hủy đơn</button>
                                                    <?php } elseif ($value['cancle_order'] == 1) {
                                                        echo '<button class="btn btn-info text-white name ="">';
                                                        echo "Chờ xác nhận";
                                                    } else { ?>
                                        ...
                                        <td>
                                            <a href="detail-history.php?orderid=<?= $value['orderid'] ?>">
