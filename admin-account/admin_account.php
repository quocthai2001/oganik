                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="header">
                                    <h3 class="title">Account Management</h3><br>
                                </div>
                                <div class="content table-responsive table-full-width">
                                    <?php
                                    require_once('../class/customer.php');

                                    $items = customer_select_all();
                                    ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="update_account.php?username=<?= $username ?>"><button class="btn btn-primary">Update</button></a>
                                                    </td>
                                                    <td>
                                                        <?php if ($role == '1') { ?>
                                                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa tài khoản này ?')" href="delete_account.php?customerid=<?= $customerid ?>">
                                                                <button class="btn btn-danger">Delete</button>
                                                            </a>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
                                                        <?php if ($role == '1' && $status == '0') { ?>
                                                            <a onclick="return confirm('Bạn có chắc chắn muốn khóa tài khoản này ?')" href="block_account.php?customerid=<?= $customerid ?>">
                                                                <button class="btn btn-warning">Block</button>
                                                            </a>
                                                        <?php }
                                                        if ($role == '1' && $status == '1') { ?>
                                                            <a onclick="return confirm('Bạn có chắc chắn muốn mở khóa tài khoản này ?')" href="unblock_account.php?customerid=<?= $customerid ?>">
                                    ...
                                    <a href="add_account.php"><button class="btn btn-danger">+ New Account</button></a>
                                </div>
                            </div>
                        </div>
