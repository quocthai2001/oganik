                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item">
                                <a href="../store/admin_store.php" class="nav-link" data-toggle="dropdown">
                            ...
                            <div class="card card-plain">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="username" value="<?= $username ?>" placeholder="Username ..." readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Customer ..." readonly>
                                    </div>
