            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9">
                                        ...
                                        <div class="product-card__image">
                                            ...
                                            <div class="product-card__image-content">
                                                ...
                                                if (isset($_SESSION['user1']) || isset($_SESSION['user'])) {
                                                    if ($item['quantity'] > 0) {
                                                ?>
                                                        <a href="add-cart.php?productid=<?= $item['productid'] ?>"><i class="organik-icon-shopping-cart"></i></a>
                                                    <?php
                                                    } else {
                                                    }
                                                } else { ?>
                                                    <a href="./account/login.php"><i class="organik-icon-shopping-cart"></i></a>
                                                <?php } ?>
                        ...
                        <div class="pagination" style="display: inline-block;margin-left:350px;">
                            <?php echo $html; ?>
                            <ul>
                                <?php
                                for ($i = 1; $i <= $total_page; $i++) {
                                    if ($i == $current_page) {
                                        ...
                                        if (isset($_GET['keyword'])) {
                                            ...
                                            href="products.php?keyword=' . $_GET['keyword'] . '&page=' . $i . '">' . $i . '</a></li ';
                                        } else {
                                            echo '<a class="page-link" 
                                            style="color: black;float: left;padding: 8px 16px;text-decoration: none;
                                            transition: background-color .3s;border-radius: 5px;" 
                                            href="products.php?page=' . $i . '">' . $i . '</a></li>';
                                        }
                                    }
                                }
                                ?>
