                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-box">
                                                    <img src="assets/images/products/<?= $images ?>" alt="" style="width:150px">
                                                    <h3><a href="product-details.php"><?= $productname ?></a></h3>
                                                </div><!-- /.product-box -->
                                            </td>
                                            ...
                                            <td>
                                                <div class="quantity-box">
                                                    ...
                                                    <input type="number" min="1" max="<?= $quantity ?>" id="2" value="<?= $sl ?>" name='sl[<?= $productid ?>]' />
                                                    <button type="button" class="add">+</button>
                                                </div>
                                            </td>
                                            <td>
                                                <?= number_format($price * $sl);
                                                $total += ($price * $sl); ?> <sup>đ</sup>
                                            </td>
                                            <td>
                                                <a onclick="return confirm('Bạn muốn bỏ sản phẩm này khỏi giỏ hàng ?')" href="delete-cart.php?productid=<?= $productid ?>"><i class="organik-icon-close remove-icon"></i></a>
                                            </td>
                                        </tr>
                                <?php }
                                } else {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="button-box">
                            <button class="thm-btn" name="btn-update" type="submit">Update</button><!-- /.thm-btn -->
                            <a href="checkout.php" class="thm-btn">Checkout</a><!-- /.thm-btn -->
                        </div><!-- /.button-box -->
                        </form>
                    </div><!-- /.col-lg-4 -->
                </div><!-- /.row -->
