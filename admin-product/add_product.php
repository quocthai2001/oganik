                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
                                ...
                                extract($_REQUEST);
                                $conn = new PDO('mysql:host=localhost;dbname=oganik', 'root', '');
                                if (array_key_exists("insert", $_REQUEST)) {
                                    ...
                                    if ($result) {
                                        ...
                                        $stmt = $conn->prepare("INSERT INTO products(productname, images, price, quantity, description, categoryid)
                                    VALUES ('$productname','$images','$price','$quantity','$description','$categoryid')");
                                        $stmt->execute();
                                        // product_insert($productname, $images, $price, $quantity, $description, $categoryid);
