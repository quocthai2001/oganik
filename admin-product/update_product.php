                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                ...
                                if (array_key_exists("update", $_REQUEST)) {
                                    $up_image = save_file("images", "../assets/images/products");
                                    $images = strlen($up_image) > 0 ? $up_image : 'product.png';

                                    product_update($productid, $productname, $price, $quantity, $images, $categoryid, $description);
                                    unset($productname, $images, $price, $quantity, $description, $categoryid);
                                    $message = "Cập nhật sản phẩm thành công !";
                                    echo "<script type='text/javascript'>alert('$message');
                                    window.location.replace('admin_product.php');
                                    </script>";
                                }
                                ?>
                                <!-- /. CONTENT  -->
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="images" value="<?= $images ?>">
                                        <input name="images" type="hidden" value="<?= $images ?>"><br>
                                        <img src="../assets/images/products/<?= $images ?>" alt="" style="width:80px"><br>
                                        (<?= $images ?>)
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="categoryid" class="form-control">
                                            ...
                                            foreach ($category as $loai) {
                                                if ($loai['categoryid'] == $categoryid) {
                                                    echo '<option selected value="' . $loai['categoryid'] . '">' . $loai['categoryname'] . '</option>';
                                                } else {
                                                    echo '<option value="' . $loai['categoryid'] . '">' . $loai['categoryname'] . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
