                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="header">
                                    <h3 class="title">Orders Management</h3><br>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $datetimes ?></td>
                                                    <td><?= $note ?></td>
                                                    <?php if ($cancle_order == 2) { ?>
                                                        <td></td>
                                                    <?php } else { ?>
                                                        <td>
                                                            <a href="status_update.php?orderid=<?= $orderid ?>">
                                                                <?php
                                                                if ($order_status == 0) {
                                                    ...
                                                    <?php } else { ?>
                                                        <td>
                                                            <a href="delete_order.php?orderid=<?= $orderid ?>">
                                                                <?php
                                                                if ($cancle_order == 1) {
                                                                    echo '<button class="btn btn-warning">';
                                                                    echo "Xác nhận hủy đơn";
                                                                } elseif ($cancle_order == 2) {
                                                                    echo '<button class="btn btn-warning">';
                                                                    echo "Đã hủy đơn";
                                                                }
                                                                ?>
                                                    ...
                                                    <?php } ?>
                                                    <td>
                                                        <a href="detail_order.php?orderid=<?= $orderid ?>"><button class="btn btn-primary">Detail</button></a>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            <?php } ?>
