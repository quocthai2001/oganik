        ...
        <section class="product_detail">
            <div class="container">
                <div class="row">
                    ...
                    extract($_REQUEST);
                    $items = product_select_by_id($productid);
                    extract($items);
                    ?>
                    <div class="col-xl-6 col-lg-6">
                        <div class="product_detail_image">
                            <img src="assets/images/products/<?= $images ?>" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="product_detail_content">
                            ...
                            <?php
                            $items = category_select_by_id($categoryid);
                            extract($items);
                            ?>
                            <ul class="list-unstyled category_tag_list">
                                <li><span>Category:</span> <?= $categoryname ?></li>
                                <?php
                                if ($quantity < 1) { ?>
                                    <li><span style="color:red"><b>SẢN PHẨM TẠM THỜI HẾT</b></span></li>
                                <?php } else { ?>
                            ...
                            <div class="product-quantity-box">
                                <div class="">
                                    ...
                                    if ($quantity < 1) {
                                        ...
                                        if (isset($_SESSION['user1']) || isset($_SESSION['user'])) { ?>
                                            <a href="add-cart.php?productid=<?= $productid ?>"><button class="thm-btn">Add to Cart</button></a>
                                        <?php } else {
                                        ?>
                                            <a href="./account/login.php"><button class="thm-btn">Please login</button></a>
                                    <?php }
                                    } ?>
                                </div>
                            </div>
